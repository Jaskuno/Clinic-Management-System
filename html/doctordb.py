...
def insert_data(email, username, address, contact_number, password):
    try:
        connection = connect_to_mysql()
        cursor = connection.cursor()

        query = "INSERT INTO doctors (doctor_Email, doctor_Address, doctor_Contact, doctor_Username, doctor_Password) VALUES (%s, %s, %s, %s, %s)"
        values = (email, address, contact_number, username, password)
...
insert_data(email, username, address, contact_number, password)
